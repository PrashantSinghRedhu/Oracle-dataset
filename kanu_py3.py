...
model.add(Convolution2D(flt1, 1, taps, padding='valid', name="conv1", kernel_regularizer=l2(l2_lambda),
                        kernel_initializer='glorot_uniform'))
model.add(Activation('relu'))
# model.add(Dropout(0.25))
model.add(ZeroPadding2D((0, 2)))
model.add(Convolution2D(flt2, 2, taps, padding="valid", name="conv2", kernel_regularizer=l2(l2_lambda),
                        kernel_initializer='glorot_uniform'))
model.add(Activation('relu'))
# model.add(Dropout(0.25))
model.add(Flatten())
